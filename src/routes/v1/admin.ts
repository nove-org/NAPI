...
router.get('/users', authorize({ disableBearer: true }), authorizeAdmin, async (req: Request, res: Response) => {
...
router.post('/users/:id/disable', authorize({ disableBearer: true }), authorizeAdmin, validate(z.object({ reason: z.string() })), async (req: Request, res: Response) => {
    const { id } = req.params;
...
router.delete('/users/:id/disable', authorize({ disableBearer: true }), authorizeAdmin, async (req: Request, res: Response) => {
    const { id } = req.params;
